Rails.application.routes.draw do
  ...
  patch '/branches/:branch_id/organization/:id/set_public_unit_id', to: 'organizations#set_public_unit_id', as: 'set_public_unit_id_branch_organization'

  patch '/branches/:branch_id/organization/:id/unset_public_unit_id', to: 'organizations#unset_public_unit_id', as: 'unset_public_unit_id_branch_organization'
