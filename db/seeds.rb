...
Departament.create(departament_name: 'Departament 2', departament_description: 'Under Main', departamentlogotype: '', subordinated: 'Main', branch_id: '1', organization_id:'1')
